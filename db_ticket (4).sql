...
--
-- Host: localhost:3306
-- Generation Time: Jan 04, 2022 at 03:06 AM
...
('1223456', 'FARRAS', 'farrasalhafizh@mail.com', '081275127265', '$2y$10$Vcw9lFB0OQaISlJUn6czmujuBTIxd8.Dz1TidLz1uM6wTuylN9jam', 3, 'f37736b80c23a6074a81e3294039619f.png'),
...
('90213123', 'FARRAS ALHAFIZH', 'farrasalhafizh45@gmail.com', '081275127265', '$2y$10$WqB5NbsTk6eqGBLB1CHV6ufu9V7oRZkZbFClYGU6qym1IZaf0rL5C', 3, 'aab1c9f98a0619655544161e11d35fc7.jpg');
...
INSERT INTO `tkt_pengaduan` (`pgd_id`, `pgd_pg_nip`, `pgd_tgl_pengaduan`, `pgd_uraian_pengaduan`, `pgd_biaya_perbaikan`, `pgd_teknisi`, `pgd_adm_keterangan`, `pgd_teknisi_status`, `pgd_jumlah_biaya_perbaikan`, `pgd_adm_status`, `pgd_umum_keterangan`, `pgd_umum_status`, `pgd_read_by_admin`, `pgd_read_by_umum`) VALUES
('LP061221000001', '12435235', '2021-11-02', 'Tes', 1, ' Irwan', 'Langsung diperbaiki teknisi', 'Belum Selesai', 50000, 'Diterima', '', 'Diterima', 1, 1),
('LP131221000002', '12435235', '2021-12-14', 'UPS tidak berfungsi', 1, 'Irwan', 'Memerlukan proses 3 hari', 'Sudah Selesai', 500000, 'Diterima', 'Jika ada biaya tambahan tidak perlu mengajukan ulang', 'Diterima', 1, 1),
('LP141221000003', '12435235', '2021-12-14', 'AC rusak', 1, '', 'Beli AC 4 PK 2 unit', 'Sudah Selesai', 2000000, 'Diterima', 'Diundur bulan depan karena kondisi finansial kantor sedang di audit, jadi tidak bisa mengeluarkan anggaran. Laporan akan dianggarkan ke resolusi bulan depan', 'Ditunda', 1, 1),
('LP201221000004', '90213123', '2021-12-20', 'Butuh tambahan kabel LAN 30 meter', 0, '', '', 'Sudah Selesai', 100000, 'Diterima', 'Project bisa dimulai minggu depan', 'Diterima', 1, 1);
...
(5, 'LP151221000004', 'Perbaikan segera diproses', '', '2021-12-15'),
(6, 'LP141221000003', 'Ditolak', 'Diundur bulan depan karena kondisi finansial kantor sedang di audit, jadi tidak bisa mengeluarkan anggaran. Laporan akan dianggarkan ke resolusi bulan depan', '2021-12-18'),
(7, 'LP061221000001', 'Selesai diperbaiki', 'tes', '2021-12-31');
...
(3, 'teknisi', '$2y$10$cAMShtmheSpnFvnkO0KLy.DM3616jv7YQeNKdm9wAC7zFuRt5vyC2', 'Teknisi IT', 'Irwan', 'Jl. Teropong', 'irwan@gmail.com', '081275127265');
...
--
ALTER TABLE `tkt_tracking`
  MODIFY `trck_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
