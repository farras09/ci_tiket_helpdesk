    ...
    <div class="col-lg-12">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <?= form_open($action, [],['id'=>$kategori['id']]); ?>
               
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="kategori">kategori</label>
                    <div class="col-md-9">
                        <input value="<?= set_value('category',$kategori['category']); ?>" name="category" id="kategori" type="text" class="form-control" placeholder="kategori...">
