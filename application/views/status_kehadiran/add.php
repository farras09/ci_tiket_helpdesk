        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('status_kehadiran'); ?>" name="status_kehadiran" id="status_kehadiran" type="text" class="form-control" placeholder="Input Status Kehadiran...">
