...
<head>
    ...
    <title>Master <?= $title; ?> | Aplikasi Ticketing Helpesk</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- <a href="<?= base_url(); ?>" ><img src="<?= base_url(); ?>assets/images/logo.png" alt="Logo" class="img-fluid container"></a> -->
            <!-- Sidebar - Brand -->
            ...
            <li class="nav-item  <?= $this->uri->segment(1) == 'dashboard' ? 'active' : ''; ?>">
                <a class="nav-link" href="<?= site_url('dashboard/pegawai'); ?>">
            ...
            <!-- <li class="nav-item  <?= $this->uri->segment(1) == 'absensi' ? 'active' : ''; ?>">
                <a class="nav-link" href="<?= site_url('absensi/historyPresensi'); ?>">
                    <i class="fas fa-fw fa-list"></i>
                    <span>History Presensi</span></a>
            </li> -->
              ...
              <li class="nav-item  <?= $this->uri->segment(1) == 'pengaduan' ? 'active' : ''; ?>">
                <a class="nav-link" href="<?= site_url('pengaduan');?>">
                    ...
                    <span>Menu Pengaduan</span></a>
            </li>

            <!-- Nav Item - Laporan -->
            <!-- <li class="nav-item  <?= $this->uri->segment(1) == 'laporan_harian' ? 'active' : ''; ?>">
            ...
            <li class="nav-item <?= $this->uri->segment(1) == 'pegawai' ? 'active' : ''; ?>">
                <a class="nav-link" href="<?= site_url('pegawai/profile/'.$this->session->userdata('login_session')['nip']);?>">
