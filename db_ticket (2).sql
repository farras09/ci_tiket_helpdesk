...
--
-- Host: localhost:3306
-- Generation Time: Dec 18, 2021 at 10:50 AM
...
('1223456', 'FARRAS', 'farras@mail.com', '081275127265', '$2y$10$Vcw9lFB0OQaISlJUn6czmujuBTIxd8.Dz1TidLz1uM6wTuylN9jam', 3, 'f37736b80c23a6074a81e3294039619f.png'),
...
INSERT INTO `tkt_pengaduan` (`pgd_id`, `pgd_pg_nip`, `pgd_tgl_pengaduan`, `pgd_uraian_pengaduan`, `pgd_biaya_perbaikan`, `pgd_adm_keterangan`, `pgd_jumlah_biaya_perbaikan`, `pgd_adm_status`, `pgd_umum_keterangan`, `pgd_umum_status`, `pgd_read_by_admin`, `pgd_read_by_umum`) VALUES
('LP061221000001', '12435235', '2021-11-02', 'Tes', 1, 'Langsung diperbaiki', 50000, 'Diterima', '', 'Diterima', 1, 1),
('LP131221000002', '12435235', '2021-12-13', 'UPS tidak berfungsi', 1, 'Memerlukan proses 3 hari', 500000, 'Diterima', 'Jika ada biaya tambahan tidak perlu mengajukan ulang', 'Diterima', 1, 1),
('LP141221000003', '12435235', '2021-12-14', 'AC rusak', 1, 'Beli AC 4 PK 2 unit', 2000000, 'Diterima', 'Diundur bulan depan karena kondisi finansial kantor sedang di audit, jadi tidak bisa mengeluarkan anggaran. Laporan akan dianggarkan ke resolusi bulan depan', 'Ditunda', 1, 1),
('LP151221000004', '90213123', '2021-12-15', 'Beli perlengkapan kantor', 0, '', NULL, 'Diterima', NULL, 'Diproses', 1, 0),
('LP181221000005', '1223456', '2021-12-18', 'Tes', 0, NULL, NULL, 'Diproses', NULL, 'Diproses', 0, 0);
...
--
ALTER TABLE `tkt_tracking`
  MODIFY `trck_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
